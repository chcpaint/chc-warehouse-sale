...
(function () {
    ...
    RAI.markup = [
        ...
        "                                Each scan adds one. Scan again to add another, or type the quantity on the line.",
        "                            </span>",
        ...
        "",
        "                    <!-- Staged: scanned but not yet written to the ledger, so a",
        "                         mis-scan is fixed here rather than needing a correcting entry. -->",
        ...
        "                                <p id=\"inv-basket-sub\" class=\"text-xs text-gray-400\">Nothing is written until you post it.</p>",
        "                            </div>",
        "                            <div class=\"flex items-center gap-2\">",
        "                                <button onclick=\"RAI.clearBasket()\" id=\"inv-basket-clear\"",
        "                                    class=\"text-sm text-gray-400 hover:text-gray-600 px-3 py-2\">Clear</button>",
        "                                <button onclick=\"RAI.commitBasket()\" id=\"inv-basket-post\"",
        "                                    class=\"bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm font-semibold disabled:opacity-40\" disabled>",
        ...
        "                            <h3 class=\"font-semibold text-gray-700\">Posted this session</h3>",
